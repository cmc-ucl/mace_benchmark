...
def generate_initial_structure():
    ...
    ase_structure = read('AlGaN_super3_27_initial.xyz')  # Load your AlN supercell (replace with your code)
...
def simulated_annealing(struct, T_init=1000, cooling_rate=0.95, steps=1000, output_file="sa_trajectory_1000.xyz"):
    ...
    for step in range(steps):
        ...
        if step % 50 == 0:
            write(output_file, all_structures, append=True)  # Append to XYZ file
            all_structures = []
